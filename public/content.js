(function () {
  ...
  s('opening', 'opening', 'hero', '내 일을 대신할\n나만의 AI AGENT 만들기.', { kicker: 'YUJIN FLOW', subtitle: '내 업무 하나를 골라\nPoC부터 Agent 설계와 실행까지.', impact: '반복하던 복사·분류 업무 → 내 Agent가 초안 처리, 사람은 검수와 승인.', hook: 'Agent 실패의 90%는 AI 성능보다 문제정의와 Process Flow 부재에서 시작합니다.', note: '오프닝. 오늘 가져갈 것은 Project, Skill ZIP, 실행 기록이다. 코드 심화는 선택 트랙이며 기본 실습은 Claude 웹으로 진행한다. 초반부터 결과물과 실패 원인을 제시해 왜 문제정의부터 하는지 설득한다.' });

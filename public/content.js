(function () {
  ...
  s('finish-line', 'opening', 'deliverables', '두 시간 동안 만들 네 가지.', { subtitle: '오늘의 결과물은 AI 기능이 아니라, 내 업무 병목을 실행 가능한 Agent 스펙으로 바꾼 문서입니다.', note: '오늘의 흐름은 문제정의, Agent 설계, 실행·검수 3개 덩어리로 안내한다. 직무 예시는 자신의 직무 한 개를 골라 본다. 나머지 예시와 Claude Code 심화는 복습용이다. 수강생이 손에 가져갈 산출물을 첫 2분 안에 명확히 선언한다.' });

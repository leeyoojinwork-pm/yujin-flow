(function () {
  ...
  function renderSlide(n, focus = false) {
    ...
    if (s.type === 'hero') {
      article.innerHTML = '<div class="slide-inner">' + header(s, active) + '<div class="hero-copy"><div class="hero-name">YUJIN FLOW</div><h1>' + titleMarkup(s).replace(/\n/g, '<br>') + '</h1><div class="hero-corner" aria-hidden="true">↗</div></div><div class="hero-bottom"><div><p>' + esc(s.subtitle) + '</p><p class="hero-impact">' + esc(s.impact) + '</p><p class="hero-hook">' + esc(s.hook) + '</p></div><div class="hero-signature"><b>이유진</b><a href="mailto:lee.yoojin.work@gmail.com">lee.yoojin.work@gmail.com</a></div></div><div class="hero-strip"><span><b>Y</b>Why Gap<small>진짜 병목은?</small></span><span><b>U</b>User Job<small>입력과 출력은?</small></span><span><b>J</b>Journey<small>흐름과 예외는?</small></span><span><b>I</b>Intelligence Fit<small>AI가 맞는 일은?</small></span><span><b>N</b>Next Agent<small>어떻게 다시 쓰나?</small></span></div><div class="hero-start">' + button('오늘의 흐름', 'next', 'arrow-right', 'lime') + '</div></div>';

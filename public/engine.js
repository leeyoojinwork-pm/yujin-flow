(function () {
  ...
  samples["agent-report-template.md"] = [
  ...
  function week2Homework(state) {
    const report = [
      ...
      '- 최종 HTML에는 이 흐름이 연결된 순서도로 보여야 합니다.',
      '',
      '### 3. Agent 역할 설계',
      ...
      '',
      '### 6. 최종 제출 파일',
      '- 최종 산출물은 single-file HTML 보고서로 만듭니다.',
      '- 브라우저에서 열어 인쇄 > PDF 저장이 가능해야 합니다.',
      '- 순서도는 Mermaid나 외부 CDN 없이 HTML/CSS로 렌더링합니다.',
      '',
      '## Claude에게 바로 붙여넣을 요청',
      '',
      '나는 내 업무를 AI Agent로 만들기 위한 2주차 제출 보고서를 작성하려고 합니다.',
      '',
      '아래 수업 중 작성한 내용과 agent-report-template.md 구조를 바탕으로 single-file HTML 보고서를 만들어 주세요.',
      '',
      '1. 문제 정의',
      '2. 업무 흐름',
      '3. AI Agent가 맡을 일',
      ...
      '9. HTML/CSS 순서도',
      '',
      '디자인은 A4 보고서처럼 정돈하되, 업무 흐름 순서도가 눈에 보여야 합니다. 외부 CDN, 외부 폰트, 외부 이미지는 쓰지 말고 HTML 한 파일 안에서 열리게 해 주세요. @media print를 넣어 PDF로 저장해도 표와 순서도가 잘리지 않게 해 주세요.',
      '',
      '예쁘게 꾸미기보다 실제로 Agent가 일할 수 있을 만큼 구체적으로 정리해 주세요. 모순되거나 비어 있는 항목은 지어내지 말고 확인 질문으로 남겨 주세요. 확인하지 않은 실행 결과나 효과 수치는 만들지 마세요.',
      '',
      '## 수업 중 작성한 내 기록',
      ''
    ].join('\n');
